...
import UserIcon from "@/assets/images/orderForm/user.svg";
import PhoneIcon from "@/assets/images/orderForm/phone.svg";
...
export const StyledPhoneIcon = styled(PhoneIcon)`
  ...
  ${generalIconStyle}
`;
export const ChangeButtonUser = styled.button<{ open: boolean }>`
  position: absolute;
  top: 16px;
  right: 16px;
...
`;
export const ChangeContainerName = styled.div<{ open: boolean }>`
  flex-direction: column;
  width: 616px;
